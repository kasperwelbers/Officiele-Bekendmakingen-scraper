...
class KamerstukkenScraper(OfficieleBekendmakingenScraper):
    ...
    def scrape_unit(self, url):
        ...
        print(url)
        #kamerwrk = xml.cssselect('kamerwrk')[0].getchildren()
        ...
        yield dict(headline=headline, byline=vraagnummer, text=body, date=date, section=section, url=url)        

if __name__ == '__main__':
    s = KamerstukkenScraper()    
    s.scrape()
